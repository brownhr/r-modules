...
<!--
Maggie, I put a backslash in front of the $ so it's not interpreted as a latex equation. 
-->
...
```
func_name <- function(arg1, arg2, etc.) {
...
Let's try it out! We'll call our function `confidence.` We need a couple arguments (inputs, options, etc.), including: our data, `x`, our population standard deviation (15,000), and our desired confidence interval (70%, or 0.7)
