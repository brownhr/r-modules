...
This summary provides a great deal of information. Of particular interest is the 'link number distribution' report: the top row of numbers is the number of links, and the bottom is the number of counties with that number of links. 

```{r nb-links, echo = FALSE}
s <- invisible(summary(queen_nb))
