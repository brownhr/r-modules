...
# This function takes a good bit of time to run! Set quiet = FALSE to see what
...
The values we're interested are our $\rho$ statistic, `Rho`, and our $p$-value. Looking at this result, we can confidently say that `Bush_pct` is strongly 